	...
	<table>
	   ...
	   <tr>
	    ...
	    <tr>
	       ...
	       <td style="border : none" width="400"><p align="center"><button type="button" id="enrollButton" onclick="location.href='${contextPath}/satisfaction/modSatisfactionForm.do?id=${vo.id }'">수정</button>&nbsp;&nbsp;&nbsp;<input type="button" onclick="history.back()" value="목록"></td>
	    </tr>
	</table>
