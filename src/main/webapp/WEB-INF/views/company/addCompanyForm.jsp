...
<body>
	<div class="process">
		...
		<span onclick="location.href='${contextPath}/company/addCompanyForm.do'" style=cursor:pointer;>> 회사등록</span></h4>
	</div>
		...
		<table id="company_add">
			...
			<tr>
				...
				<td width="10%" class="td2">
					<div class="oNum">
						<input type="text" id="num" name="companyTel1" maxLength="3" pattern="\d{2,3}">-
							<input type="text" id="num" name="companyTel2" maxLength="4" pattern="\d{3,4}">-
							<input type="text" id="num" name="companyTel3" maxLength="4" pattern="\d{4}">
							<input type="hidden" name="companyTel">
					</div>
				</td>
				<td width="10%" class="td1"><p align="right">홈페이지</p></td>
				<td width="20%" class="td1"><input type="text" name="homePage" id=t1 required></td>
			</tr>

			<tr>
				<td width="10%" class="td1" rowspan="2"><p align="right">주소</p></td>
				<td width="20%" class="td1" colspan="3"><input type="text" id=zipCode name="zip" placeholder="우편번호" readonly>
			...
			<tr>
				...
				<td width="10%" class="td2">
					<div class="oNum">
						<input type="text" id="id" name="id1" maxLength="3" pattern="\d{3}">-
						<input type="text" id="id" name="id2" maxLength="2" pattern="\d{2}">-
						<input type="text" id="id" name="id3" maxLength="5" pattern="\d{5}">
			...
			<tr>
				...
				<td width="20%" class="td2">
					<div class="oNum">
						<input type="text" id="num" name="managerPhone1" maxLength="3" pattern="(010)">-
						<input type="text" id="num" name="managerPhone2" maxLength="4" pattern="\d{3,4}">-
						<input type="text" id="num" name="managerPhone3" maxLength="4" pattern="\d{4}">
						<input type="hidden" name="managerPhone">
					</div>
				</td>
