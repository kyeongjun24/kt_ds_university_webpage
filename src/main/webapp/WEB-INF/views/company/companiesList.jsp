...
<body>
	...
	<form id="under_excelButton" action="${contextPath}/company/excelDownload.do" method="post">
		<div class="memberButton">
			<button type="button" id="enrollButton"
				onclick="location.href='${contextPath}/company/addCompanyForm.do'">등록</button>
			<button type="button" onclick='getCheckList()'>삭제</button>
			<input type="submit" value='엑셀 다운로드' id="excel">
		</div>
	</form>
