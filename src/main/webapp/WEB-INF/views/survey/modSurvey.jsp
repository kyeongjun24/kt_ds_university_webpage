...
<body>
	<form method="post"   action="${contextPath}/survey/modSurvey.do" id=updateFrm>
	...
	<table  align="center" >
	   ...
	   <tr>
	    ...
	    <tr>
			...
			<td colspan=2><input class="modSurvey_content" name="contents" rows="10" cols="65" maxlength="4000" value="${vo.contents }"></input>
	    ...
	    <tr>
	       ...
	       <td style="border : none" width="400"><input type="submit" value="수정하기" id="enrollButton">&nbsp;<input type="button" onclick="history.back()" value="취소"></td>
	    </tr>
	</table>
	</form>
</body>
